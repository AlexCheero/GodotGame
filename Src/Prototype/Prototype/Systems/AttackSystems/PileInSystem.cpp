...
{
	auto checkForPileInView = registry.view<AttackActionTag, TargetLockComponent, MeleeAttackComponent, KinematicBody*>(entt::exclude<PileInTag>);
	checkForPileInView.less([&registry](entt::entity entity, TargetLockComponent lockComp, MeleeAttackComponent melee, KinematicBody* pKBody)
	{
